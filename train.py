...
def main(args):
    ...
    model = load_model[args.model_name](graph_type='Contextualized Supply Chain Graph', init_prompt="Please answer the given question.", args=args) # remove ", init_prompt=dataset.prompt" from the parameter list
